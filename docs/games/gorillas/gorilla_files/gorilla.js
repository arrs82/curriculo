...
function* Intro() {
  ...
  // Removido o branding JavaScript / QBasic
  // Center(3, "JavaScript                     ");
  ...
  Center(9,  "    Sua missao e acertar seu oponente com a banana");
  Center(10, "    explosiva, variando o angulo e a forca do arremesso");
  Center(11, "    no horizonte da cidade, levando em conta a velocidade,");
  Center(12, "    a  gravidade  e a velocidade do vento.  A velocidade  do");
  Center(13, "    vento  e  mostrada  por  uma  seta direcional vermelha  na");
  Center(14, "    parte inferior do campo e seu tamanho e relativo a forca.");
  Center(16, "    Observacao: Jogo convertido para JavaScript e em");
  Center(17, "    fase de testes e adaptacao em mobiles!!!");
  Center(19, "    ALESSANDRO ROBERTO DOS REIS SANTOS");
  Center(20, "    Whatsapp: (12) 98867-8750");
  Center(24, "    Pressione qualquer tecla para continuar");

//  scr.line(250, 14*5+3, 470, 14*6-3, 4);
  //  scr.line(254, 14*6-4, 465, 14*5+4, 4);
  Center(7, "                        & aleha.santos 2025");
...
function* GetInputs(pPlayer1, pPlayer2, pNumGames) {
  ...
  scr.locate(8, 15);
  scr.print("Nome do Jogador 1 (Padrao = 'Jogador 1'): ");
  scr.flip();
  pPlayer1[0] = yield* lineInput();
  if (pPlayer1[0] === "") {
    pPlayer1[0] = "Jogador 1";
  } else {
    pPlayer1[0] = pPlayer1[0].slice(0, 10);
  }

  scr.locate(10, 15);
  scr.print("Nome do Jogador 2 (Padrao = 'Jogador 2'): ");
  scr.flip();
  pPlayer2[0] = yield* lineInput();
  if (pPlayer2[0] === "") {
    pPlayer2[0] = "Jogador 2";
  } else {
  ...
  do {
    ...
    scr.print(spaces(25));
    scr.locate(12, 13);
    scr.print("Jogue quantas partidas quiser (Padrao = 3)? ");
    scr.flip();
  ...
  do {
    ...
    scr.print(spaces(28));
    scr.locate(14, 17);
    scr.print("Gravidade em Metros/Seg (Terra = 9.8)? ");
    scr.flip();
...
function* GorillaIntro(pPlayer1, pPlayer2) {
  ...
  scr.locate(18, 34); scr.print("V = Ver Intro");
  scr.locate(19, 34); scr.print("P = Jogar");
  scr.locate(21, 35); scr.print("Sua Escolha?");
  scr.flip();
...
//  scr.setPalette(OBJECTCOLOR, BackColor);
  ...
  if (char.toUpperCase() === 'V') {
    ...
    Center(5, "                ESTRELANDO               ");
    Center(7, pPlayer1[0] + " E " + pPlayer2[0]);
...
function* PlayGame(pPlayer1, pPlayer2, pNumGames) {
  ...
  scr.locate(25, 1); scr.print("Pressione qualquer tecla para continuar");
  scr.flip();
  yield {cmd:"key"};
}
...
function* DoShot(pPlayerNum, x, y) {
  ...
  scr.print("Velocidade:");
  var Velocity = yield* GetNum(3, LocateCol + 11);
