...
| :material-microsoft-visual-studio-code: VSCode             | :material-close-circle:{ style="color: #d3d3d3; font-size:22px;" } | :material-check-circle:{ style="color: green; font-size:22px;" } | :material-close-circle:{ style="color: #d3d3d3; font-size:22px;" } |
...
| :simple-mikrotik: MikroTik                                  | :material-close-circle:{ style="color: #d3d3d3; font-size:22px;" } | :material-close-circle:{ style="color: #d3d3d3; font-size:22px;" } | :material-check-circle:{ style="color: green; font-size:22px;" } |
...
| :spider: CopySpider                                  | :material-close-circle:{ style="color: #d3d3d3; font-size:22px;" } | :material-check-circle:{ style="color: green; font-size:22px;" } | :material-close-circle:{ style="color: #d3d3d3; font-size:22px;" } |
