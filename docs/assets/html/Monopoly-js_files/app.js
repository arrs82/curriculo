...
(function() {
	...
	exports.COMMUNITY_CHEST = 'Cofre';
	exports.INCOME_TAX = 'Imposto de Renda';
	exports.LUXURY_TAX = 'Taxa de Riqueza';
	exports.LUXURY_TAX_DESCRIPTION = "Pague R$75";
	exports.INCOME_TAX_DESCRIPTION = "Pague 10% ou R$200";
	exports.START_DESCRIPTION = "Receba salário de R$200 ao passar aqui";
	exports.VISITING_JAIL = "Apenas Visitante";
	exports.FREE_PARKING = "Estacionamento Grátis";
	exports.GO_TO_JAIL = "Vá para a Cadeia";
	
	exports.COMPANY_WATER = 'Companhia de Distribuição de Água';
	exports.COMPANY_ELECTRIC = "Companhia de Energia";
	
	exports.RAILROAD_READING = 'Est. de Metrô Maracanã';
	exports.RAILROAD_PENN = 'Est. de Metrô Carioca';
	exports.RAILROAD_B_O = 'Est. de Metrô Consolação';
	exports.RAILROAD_SHORT = 'Est. de Metrô República';
	
	exports.PROPERTY_MD = 'Av. Sumaré';
	exports.PROPERTY_BT = 'Praça da Sé';
	exports.PROPERTY_ET = "Rua 25 de Março";
	exports.PROPERTY_VT = 'Av. São João';
	exports.PROPERTY_CN = 'Av. Paulista';
	exports.PROPERTY_CL = 'Av. Vieira Souto';
	exports.PROPERTY_US = 'Niterói';
	exports.PROPERTY_VN = 'Av. Atlântica';
	exports.PROPERTY_JK = 'Av. Presidente Juscelino Kubitschek';
	exports.PROPERTY_TN = 'Av. Engenheiro Luís Carlos Berrini';
	exports.PROPERTY_NY = 'Av. Brigadeiro Faria Lima';
	exports.PROPERTY_KT = 'Ipanema';
	exports.PROPERTY_IN = 'Leblon';
	exports.PROPERTY_IL = 'Copacabana';
	exports.PROPERTY_AT = 'Av. Cidade Jardim';
	exports.PROPERTY_VR = 'Pacaembú';
	exports.PROPERTY_MN = 'Ibirapuera';
	exports.PROPERTY_PA = 'Barra da Tijuca';
	exports.PROPERTY_NC = 'Jardim Botânico';
	exports.PROPERTY_PN = 'Lagoa Rodrigo de Freitas';
	exports.PROPERTY_PK = 'Av. Morumbi';
	exports.PROPERTY_BW = 'Rua Oscar Freire';
	
	// Player name
	exports.DEFAULT_PLAYER_NAME = 'Jogador {index}';
	
	// Player types
	exports.PLAYER_TYPE_HUMAN = 'Humano';
